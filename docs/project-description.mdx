...
import FuturePerspectives from '../src/components/HomepageFeatures/FuturePerspectives';


## The Problem: Today’s bioproduction is expensive, inaccessible and unreliable.
...
<div
  style={{
    ...
    gap: '1.2 rem',           // space between items
    padding: '3 rem 1.5rem', // internal spacing
    marginBottom: '0 rem',   // space below the grid
...
## The Solution: STREAMlining bioproduction
