...
import metabolic_burden from '../src/components/HomepageFeatures/metabolic_burden';
import expensive_hardware from '../src/components/HomepageFeatures/expensive_hardware';

## Today’s bioproduction is expensive, inaccessible and unreliable.


|<BioproductionOscillations/>|<metabolic_burden/>|<expensive_hardware/>
